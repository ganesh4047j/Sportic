...
import '../Main Screens/connections.dart';
  ...
  return Card(
    ...
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          /// 🔥 Share Code Box - Make it Clickable
          GestureDetector(
            onTap: () {
              if (isTeamCreated && teamCode != null) {
                Clipboard.setData(ClipboardData(text: teamCode));// Copy to clipboard
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: isTeamCreated
                    ...
                    : () {
                  final generatedCode = generateRandomTeamCode();
                  ref.read(teamCodeProvider.notifier).state = generatedCode;
                  ref.read(isTeamCreatedProvider.notifier).state = true;
                },
                style: ElevatedButton.styleFrom(
                  elevation: 10,
          ...
          Column(
            ...
            children: [
              ...
              const Divider(color: Colors.white, thickness: 1, indent: 6, endIndent: 6),
            ],
          ),
        ],
      ),
